    ...
    def generate():
        ...
        try:
            ...
            if was_aborted:
                ...
                yield "data: " + json.dumps(
                    {"type": "aborted", "run_id": run_id, "content": "Script aborted\n"}
                ) + "\n\n"
            else:
...
def import_github():
    ...
    try:
        req = urllib.request.Request(
            url, headers={"User-Agent": "Mozilla/5.0 DevShell"}
        )
...
def raise_pr():
    ...
    try:
        ...
        subprocess.run(
            ["git", "checkout", default_branch], check=True, capture_output=True
        )
